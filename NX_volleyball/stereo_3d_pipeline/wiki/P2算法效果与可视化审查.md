...
2026-07-05 补充: 自研 CUDA Template/NCC 单算法 isolated `100.1fps`、`1372/1374` 有效、algo `0.30/1.06/1.20/4.89ms`，当前替代 OpenCV CUDA TemplateMatching 作为默认 `z_roi_cuda_template_match` 后端。SuperPoint 160/top64 batch=2 + GPU mutual-NN 已接入 P2 sidecar，stride=2 relaxed 为 `99.6fps`、`920/920` 有效，但每帧运行不准入。
