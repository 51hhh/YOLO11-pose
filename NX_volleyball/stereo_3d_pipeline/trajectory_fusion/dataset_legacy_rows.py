"""Legacy trajectory CSV row parsing."""
...
try:
    from .dataset_io import safe_float as _safe_float
except ImportError:
    from dataset_io import safe_float as _safe_float  # type: ignore


def parse_legacy_row(row: dict[str, str]) -> Dict[str, float]:
    return {
