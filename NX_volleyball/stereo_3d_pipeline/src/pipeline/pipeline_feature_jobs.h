...
enum P2FeatureDepthMode : uint32_t {
    ...
    P2_DEPTH_MODE_VPI_TEMPLATE = 1u << 15,
    P2_DEPTH_MODE_VPI_STEREO = 1u << 16,
    P2_DEPTH_MODE_VPI_HARRIS_LK = 1u << 17,
    P2_DEPTH_MODE_VPI_ORB = 1u << 18,
    P2_DEPTH_MODE_CUDA_GFTT_LK = 1u << 19,
    P2_DEPTH_MODE_CUDA_SIFT = 1u << 20,
    P2_DEPTH_MODE_LIBSGM = 1u << 21,
    P2_DEPTH_MODE_CUDA_HOUGH_CIRCLE = 1u << 22,
};
